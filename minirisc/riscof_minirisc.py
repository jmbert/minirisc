...
class minirisc(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = "/home/joe/src/minirisc/runTest.sh"
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for minirisc start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
